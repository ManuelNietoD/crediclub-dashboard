...
def render(df: pd.DataFrame, emp_raw: pd.DataFrame):
    ...
    # Guardar copia con nombres originales para scatter ANTES de renombrar
    scatter_df = ranking[["sucursal","cartera","pct_mora","creditos","subdireccion"]].copy()
    ...
    fig_sc = px.scatter(
        ...
        labels={"cartera":"Cartera Total ($)","pct_mora":"% de Mora",
                "creditos":"Créditos","subdireccion":"Dirección"},
        size_max=45,
    )
